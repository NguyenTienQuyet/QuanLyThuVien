                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="col-sm-9" >
                                <div class="form-group" >
                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1" style="margin-top: 22px;">Role Type:</label>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="col-sm-9">
                                <div class="form-group">
                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1" style="margin-top:  12px;">Role Type:</label>
