...
jQuery(function($) {
    ...
    //     $('#_author_id').val($(this).attr('id'));
    //     $('#_edit_author_id').val($(this).attr('id'));
    ...
    //     $('#_genre_id').val($(this).attr('id'));
    //     $('#_edit_genre_id').val($(this).attr('id'));
    ...
    $.ajax({
        ...
        url: '/api/v1/books/'+'all?relations[]=authors&relations[]=genres',
        type: 'get',
        dataType: 'json',
